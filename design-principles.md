...
If multiple observations share one causal source, the system should avoid treating them as unrelated defects.
...
Saved analyses retain the version context that produced them.
